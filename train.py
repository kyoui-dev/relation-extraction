...
from src.load_data import RE_Dataset, load_data, tokenized_dataset, label_to_num
...
def train():
	...
	# load dataset
	train_dataset = load_data("./data/train_processed.csv")
	validation_dataset = load_data("./data/validation_processed.csv")
